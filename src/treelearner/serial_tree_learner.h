...
//LGBM_CUDA
#ifdef TIMETAG
  std::chrono::duration<double, std::milli> GetInitTrainTime() {return init_train_time_; };
  std::chrono::duration<double, std::milli> GetInitSplitTime() {return init_split_time_; };
  std::chrono::duration<double, std::milli> GetHistTime() {return hist_time_; };
  std::chrono::duration<double, std::milli> GetFindSplitTime() {return find_split_time_; };
  std::chrono::duration<double, std::milli> GetSplitTime() {return split_time_; };
#endif
  ...
  */
  ...
  // LGBM_CUDA
#ifdef TIMETAG
  std::chrono::duration<double, std::milli> init_train_time_ = std::chrono::milliseconds(0);
  std::chrono::duration<double, std::milli> init_split_time_ = std::chrono::milliseconds(0);
  std::chrono::duration<double, std::milli> hist_time_ = std::chrono::milliseconds(0);
  std::chrono::duration<double, std::milli> find_split_time_ = std::chrono::milliseconds(0);
  std::chrono::duration<double, std::milli> split_time_ = std::chrono::milliseconds(0);
#endif
